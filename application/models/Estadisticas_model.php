...
class Estadisticas_model extends CI_Model {
	...
	{
		$query = $this->db->query(" SELECT count(pe.id_pedido) 
									FROM  pedido pe 
	...
	{
		$query = $this->db->query(" SELECT count(pr.id_producto), pr.nombre
									FROM 	pedido pe,
											pedido_producto pp,
									        producto pr
									WHERE
	...
	{
		$query = $this->db->query(" SELECT count(u.id_usuario), u.email
									FROM 	pedido pe,
											usuario u
									WHERE
	...
	{
		$query = $this->db->query(" SELECT count(pe.id_forma_entrega), fe.descripcion
									FROM 	pedido pe,
											forma_entrega fe
									WHERE
	...
	{
		$query = $this->db->query(" SELECT count(fp.id_forma_pago), fp.descripcion
									FROM 	pedido pe,
											forma_pago fp
									WHERE
