...
class grocery_CRUD extends grocery_CRUD_States
{
	...
	protected $table_title 				= null;
	protected $table_title_plural 		= null;
	...
	protected function _load_language()
	{
		...
		$this->table_title = $this->table_title === null ? $this->l('list_record') : $this->table_title;		
...
//@todo ui_day, ui_month, ui_year has to be lang strings
	...
	protected function get_common_data()
	{
		...
		$data->table_title_plural 		= $this->table_title_plural;
